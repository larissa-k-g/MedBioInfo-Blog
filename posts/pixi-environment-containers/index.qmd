...
`$pixi shell`. This allows you to forget about pixi and just run your commands as "normally" e.g. `$quarto --help. To leave it again, just type exit into the commandline and press enter.
